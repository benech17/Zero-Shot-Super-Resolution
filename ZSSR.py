...
class ZSSR:
    ...
    def build_network(self, meta):
        with self.model.as_default():
            ...
            self.train_op = AdamOptimizer(learning_rate=self.learning_rate_t).minimize(self.loss_t)
    ...
    def learning_rate_policy(self):
        ...
        if (not (1 + self.iter) % self.conf.learning_rate_policy_check_every
            ...
            print(np.polyfit(self.mse_steps[-int(self.conf.learning_rate_slope_range /
